...
public class MyCodeActivity extends Activity {
	private ImageView my_code_image;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		my_code_image.setImageBitmap(createQRImage(regId,
				(int) (screenWidth * 0.6f), (int) (screenWidth * 0.6f)));
	}

	private void init() {
		my_code_image = (ImageView) findViewById(R.id.my_code_image);
